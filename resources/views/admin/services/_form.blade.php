...
<script>
    function initializeServiceCropper() {
        console.log('initializeServiceCropper called.');
        let cropper;
        ...
        console.log('Elements found:', { imageUpload, imageCropModal, imageToCrop, cropButton, cancelCropButton, serviceForm });

        if (!imageUpload || !imageCropModal || !imageToCrop || !cropButton || !cancelCropButton || !serviceForm) {
            ...
            if (files && files.length > 0) {
                ...
                reader.onload = function (event) {
                    ...
                    cropper = new Cropper(imageToCrop, {
                        aspectRatio: 4 / 3, // Adjust aspect ratio as needed for your service images
                        viewMode: 1,
                        autoCropArea: 0.8,
                    });
        ...
        cropButton.addEventListener('click', function () {
            ...
            if (cropper) {
                cropper.getCroppedCanvas().toBlob((blob) => {
                    ...
                    const file = new File([blob], "service_image.png", { type: "image/png" });
